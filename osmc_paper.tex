...
\begin{figure}[tbp]
	...
	\caption{OSMC front and back with rear wall removed to show the bracing and damping. The red parts of the Basotect damping are removed using a large knive.}
