...
The inside surfaces of the cabinet are lined with melamine foam absorbers (Basotect, Ewos ME50SK Pyramid) and the top is stuffed with sheeps wool (\figr{osmc_photos}, right) to absorb the low-midrange sound radiated from the woofer into the cabinet. The recommended amount and arrangement of damping materials is shown in \figr{osmc_photos}, but experimenting with the damping materials allows tweaking the OSMC sound character in the low midrange and bass a bit. Make sure not to obstruct the space between the woofer and the bass-reflex port.
