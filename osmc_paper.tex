...
\resistor{T2}	& \SI{1.0}{\Ohm} to \SI{1.3}{\Ohm} / \SI{10}{W}		& MOX or wire wound (non-inductive) (e.g.~Mundorf MRES20), higher value results in slightly less treble\cite{osmc_p1164}\\
